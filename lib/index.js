...
class Statebox {
  constructor (options = {}) {
    ...
    this.resources.registerResolver('module', Modules.moduleResolver)
  ...
  createModuleResource (moduleName, moduleClass) {
    Modules.createModule(moduleName, moduleClass)
  }

  createModuleResources (moduleResources) {
    Modules.createModules(moduleResources)
  }
  ...
  findModuleByName (name) {
    return Modules.findModuleByName(name)
  }
